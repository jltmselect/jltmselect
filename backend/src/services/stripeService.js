...
export class StripeService {
  ...
  static async createBidAuthorizationIntent(
    customerId,
    paymentMethodId,
    amount,
    description,
    ...
    try {
      ...
      throw new Error(
        `Bid authorization intent creation failed: ${error.message}`,
      );
    }
  }

  static async createImmediateCharge(
    customerId,
    paymentMethodId,
    amount,
    description,
    ...
    try {
      ...
      throw new Error(`Immediate charge failed: ${error.message}`);
    }
  }
}
