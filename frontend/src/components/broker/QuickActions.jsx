...
function QuickActions() {
    ...
    const actions = [
        { label: 'Create Listing', icon: <Plus size={18} />, action: () => navigate('/broker/auctions/create') },
        { label: 'Manage Listings', icon: <Edit size={18} />, action: () => navigate('/broker/auctions/all') },
    ];
